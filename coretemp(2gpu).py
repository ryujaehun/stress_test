...
def probe_for_duration(hour=0, minute=0, second=0):
    ...
    while nb_probes < NB_PROBES:
        ...
        plot_temperatures(cpu_temps,gpu_temps0,gpu_temps1)


    #return cpu_temps, gpu_temps

def plot_temperatures(cpu_temps, gpu_temps0,gpu_temps1):
    ...
    plt.legend([gpu_plot0,gpu_avg_plot0,gpu_plot1,gpu_avg_plot1,cpu_plot,cpu_avg_plot],
               ["GPU0 temperature", "Average GPU0 temperature : %.1fC" %(gpu_avg0),"GPU1 temperature", "Average GPU1 temperature : %.1fC" %(gpu_avg1),
